...
- [ ] **6.9 Env vars & Dokploy crons**: `SMTP_*` vars + `APP_BASE_URL`. Two new cron services: `eepp-worker-digest` (Mondays 09:00) and `eepp-worker-cleanup` (daily 02:00).

(details: docs/sprints/sprint_6_notifications.md)
