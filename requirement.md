...
- [ ] **6.10 Env vars & Dokploy crons**: `SMTP_*` vars + `APP_BASE_URL`. Three new cron services: `eepp-worker-weekly-digest` (Mondays 09:00), `eepp-worker-queue-cleanup` (daily 02:00). (details: docs/sprints/sprint_6_notifications.md)
